...
export default function Footer() {
  ...
  const [inDetailView, setInDetailView] = useState<'about' | 'project-pink' | 'project-dark' | 'project-sigma' | null>(null);
  ...
  const linkIdleColor = isDarkBackground ? 'rgba(255, 255, 255, 0.6)' : inDetailView !== null ? 'rgba(0, 0, 0, 0.6)' : 'rgba(255, 255, 255, 0.6)';
  const linkHoverColor = isDarkBackground ? 'white' : inDetailView !== null ? 'black' : 'white';
  const tooltipColor = isDarkBackground ? 'rgba(255, 255, 255, 0.4)' : inDetailView !== null ? 'rgba(0, 0, 0, 0.4)' : 'rgba(255, 255, 255, 0.4)';
  const watermarkColor = isDarkBackground ? 'rgba(255, 255, 255, 0.3)' : inDetailView !== null ? 'rgba(0, 0, 0, 0.3)' : 'rgba(255, 255, 255, 0.3)';
            ...
            {link.hoverIcon === 'spaceship' && hoveredLink === link.name && (
              ...
              >
                <path
                  ...
                  fill={isDarkBackground ? 'white' : inDetailView !== null ? 'black' : 'white'}
                />
                <path
                ...
                <circle
                  ...
                  cy="16"
                  r="2"
                  fill={isDarkBackground ? '#666666' : inDetailView !== null ? '#cccccc' : '#666666'}
                />
                <path
                  d="M14 14L10 16L14 18L12 16L14 14Z"
                  fill={isDarkBackground ? '#CCCCCC' : inDetailView !== null ? '#666666' : '#CCCCCC'}
                  opacity="0.6"
                />
                <g style={{ animation: 'flameFlicker 0.3s ease-in-out infinite' }}>
                  <path
                    ...
                    fill={isDarkBackground ? 'white' : inDetailView !== null ? 'black' : 'white'}
                    opacity="0.9"
                    filter={isDarkBackground ? 'url(#flameGlow)' : inDetailView !== null ? 'url(#flameGlowBlack)' : 'url(#flameGlow)'}
                  />
                  <path
